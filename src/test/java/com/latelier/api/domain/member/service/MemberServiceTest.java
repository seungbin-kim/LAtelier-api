...
class MemberServiceTest {
    ...
    void addMemberSuccess(@AggregateWith(SignUpRequestAggregator.class) ReqSignUp req) {
        ...
        // when
        Member savedMember = memberService.addMember(req);

        // then
        assertEquals(req.getEmail(), savedMember.getEmail());
        assertEquals(req.getUsername(), savedMember.getUsername());
        assertEquals(req.getPhoneNumber(), savedMember.getPhoneNumber());
        assertEquals(req.getRole(), savedMember.getAuthority().getRoleName());
    }
